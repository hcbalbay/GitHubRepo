...
public class TodoCursorAdapter extends RecyclerView.Adapter <TodoCursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int idIndex = mCursor.getColumnIndex(VTBaglanti.TaskEntry._ID);
        int descriptionIndex = mCursor.getColumnIndex(VTBaglanti.TaskEntry.COLUMN_DESCRIPTION);
        int priorityIndex = mCursor.getColumnIndex(VTBaglanti.TaskEntry.COLUMN_PRIORITY);
        int timeIndex = mCursor.getColumnIndex(VTBaglanti.TaskEntry.COLUMN_TIME);
        int dateIndex = mCursor.getColumnIndex(VTBaglanti.TaskEntry.COLUMN_DATE);
